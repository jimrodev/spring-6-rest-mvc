...
class CategoryRepositoryTest {
    ...
    // V168 - 169 Hay una transacción * Implícita * al ser entities con relaciones, es decir vaios sentencias sobre la bbdd
    @Transactional
    @Test
    void testAddCategory() {
        ...
        Beer saveBeer2 = beerRepository.save(testBeer);

        System.out.println(saveBeer2.getBeerName());
